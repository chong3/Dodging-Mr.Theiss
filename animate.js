...
function RenderNewObject(context) {
  ...
  context.fillRect(NEW_OBJECT.x, NEW_OBJECT.y, 50, NEW_OBJECT.a);
  if (NEW_OBJECT.x > GAME.canvas.width) {
    NEW_OBJECT.x = 0;
  } else if (NEW_OBJECT.x < -50) {
        NEW_OBJECT.a= Math.random()*270;
  ...
  context.fillRect(NEW_OBJECT.x, NEW_OBJECT.a+75, 50, 300);
  if (NEW_OBJECT.x > GAME.canvas.width) {
    NEW_OBJECT.x = 0;
  } else if (NEW_OBJECT.x < -50) {
        NEW_OBJECT.a= Math.random()*270;
